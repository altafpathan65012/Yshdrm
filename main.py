...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6786269786:AAERja8q3Z3VQytOTFnELZCmGVvtfwzTuDU")
    API_ID = int(os.environ.get("API_ID", "22871928"))
    ...
    GROUPS = os.environ.get('GROUPS', '-4187047902').split(',')
